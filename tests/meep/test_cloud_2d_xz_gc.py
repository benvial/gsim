...
``test_cloud_2d_xz_gc/test_2d_xz_gc.npz``.  On the first run the file is
generated automatically; use ``--force-regen`` to overwrite it.
"""
...
from tests._cloud_fixtures import make_2d_xz_gc_sim
